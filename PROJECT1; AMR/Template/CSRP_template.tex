...
\end{figure}
\vspace{2em}
\textbf{\Huge{Antimicrobial Resistance Title}}\\[2em]
\textbf{\LARGE{by}}\\
\vspace{2em}
...
\Large{July 2019}\\
\vspace{3em}
\normalsize{Supervised by\\ \textcolor{red}{INSERT NAME HERE}}
\vfill
\end{titlepage}
...
\flushleft
Thanks to my (...), and also to my best friend (...), and also to the fact I have no friends! Lol XD BANTER.
...
\end{center}
This is my own work, except the people I referenced. But I referenced them so it's FINE. 
...
\textbf{Note:} Should I include an overview of each section here?
