...
PRIOR.mc.2 <- c(set_prior('normal(0,3)', class = 'Intercept'), 
...
mc.2.post <- brm(bf(Proportion_Gr ~ (1 + AvgAge_sc + l_DDDp1kOBD*Route|Class_Gr)) +
...
saveRDS(mc.2.post, 'Models/MC_2_Post.rds')
