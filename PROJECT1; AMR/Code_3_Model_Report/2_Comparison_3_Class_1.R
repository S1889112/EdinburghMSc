...
PRIOR.mc.3.1 <- c(set_prior('normal(0,3)', class = 'Intercept'), 
...
mc.3.1.post <- brm(bf(Proportion_Gr ~ AvgAge_sc + l_DDDp1kOBD*Route + (1|Class)) +
...
saveRDS(mc.3.1.post, 'Models/MC_3_1_Post.rds')
