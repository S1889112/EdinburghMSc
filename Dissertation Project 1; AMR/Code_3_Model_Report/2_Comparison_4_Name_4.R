...
PRIOR.mc.4.4 <- c(set_prior('normal(0,3)', class = 'Intercept'), 
...
mc.4.4.post <- brm(bf(Proportion_Gr ~ AvgAge_sc + Route+ l_DDDp1kOBD + (1 |Name)) +
...
saveRDS(mc.4.4.post, 'Models/MC_4_4_Post.rds')
