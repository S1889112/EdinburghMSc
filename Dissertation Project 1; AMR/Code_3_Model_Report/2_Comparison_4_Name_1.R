...
PRIOR.mc.4.1 <- c(set_prior('normal(0,3)', class = 'Intercept'), 
...
mc.4.1.post <- brm(bf(Proportion_Gr ~ AvgAge_sc + l_DDDp1kOBD*Route + (1|Name)) +
...
saveRDS(mc.4.1.post, 'Models/MC_4_1_Post.rds')
